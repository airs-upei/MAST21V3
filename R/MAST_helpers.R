.onLoad <- function(...) {
  shiny::addResourcePath(
    ...
    directoryPath = system.file("www", package = "MAST21V3") # path to resource in your package
  )
}
...
make_up_an_ending <- function (page_title, page_text, sub_text) {
  ...
  make_ending_file <- "MAST-assets/make_up_ending/end_melody_low.wav"
